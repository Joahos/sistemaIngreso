...
public class PermisosController implements Serializable {
    ...
    @EJB
    private com.syscompraventa.business.facade.PermisosFacade ejbFacade;
    private static final Logger LOG = Logger.getLogger(PermisosController.class.getName());
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/mensajes").getString("PermisosCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/mensajes").getString("PermisosUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/mensajes").getString("PermisosDeleted"));
        if (!JsfUtil.isValidationFailed()) {
