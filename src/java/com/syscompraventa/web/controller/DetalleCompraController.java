...
public class DetalleCompraController implements Serializable {
    ...
    @EJB
    private com.syscompraventa.business.facade.DetalleCompraFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/mensajes").getString("DetalleCompraCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/mensajes").getString("DetalleCompraUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/mensajes").getString("DetalleCompraDeleted"));
        if (!JsfUtil.isValidationFailed()) {
